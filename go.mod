module github.com/AdonisNetwork/adonis-edge
...
require (
	github.com/AdonisNetwork/go-ibft 
...
require (
  github.com/AdonisNetwork/adonis-edge v1.3.3
...
replace github.com/0xPolygon/polygon-edge v1.3.3 => github.com/AdonisNetwork/adonis-edge v1.3.3
